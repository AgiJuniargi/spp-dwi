...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="home.php" style="margin-left: 30px;">Beranda</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link text-white" href="pembayaran-petugas.php"><b>Pembayaran</b></a>
                </li>
            </ul>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: 230px;background-image: url(img/pembayaran-bg.png); background-position: center; background-size:cover;">
        <div class="text-center text-white">
            ...
            <p class="lead">Lihat & Entri Transaksi Pembayaran disini!</p>
        </div>
    </div>
    <!-- End Banner -->
